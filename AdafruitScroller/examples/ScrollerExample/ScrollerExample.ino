...
#include "AdafruitScroller.h" // Calling Scroller Lib
...
void setup () {
  ...
  scrollers[1] = new Scroller(0, 128, 22, "scrolling line example", display, 0); // default scrolling line (only scrolls if text is bigger than what fits in the display area)
