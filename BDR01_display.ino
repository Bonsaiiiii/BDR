...
/*class Scroller {
  ...
  public:  
    Scroller(int initialPos, int endPos, int heightPos, char* variableText) {
    ...
    void scrollLine() {
      ...
      int variableTextSize = String(variableText).length() * 6;
      ...
      if (currentMillis - lastUpdate > 100) {
        ...
        display.fillRect(initialPos, heightPos, displayArea, 10, 0);  
        
        if (variableTextSize >= displayArea) {
...
void page_client(int page, int statusOUT, int Swifi, int Sntrip, int Ssaida, int PDvolts, char* rssi, char* Nlaten, char* uptim, char* lat,
char* lon, char* alt, char* pre, char* utc, char* tensao, char* pacot, char* Slaten, char* modelo, char* firmware, char* serial) {
...
void page_local(int page, int statusOUT, int Ssaida, int PDvolts, char* Wusers, char* Nport, char* baud, char* pari, char* data, char* stop,
...
void setup() {
  ...
  scrollerInitClientSource("aaaaaaAAAAAAA", "bbbbvvvvvvb", "ccccccccccccc");
  //scrollerInitLocal("aaaaaaaaaaaaaaaaaa", "bbbbbbbbbbbbbbb", "ccccccccccccccc", "ddddddddddddddddd", "eeeee", "ffffff");
  display.display();
}

int currentPage = 0;
void loop() {
  //page_client(currentPage, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
  //page_local(currentPage, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
  page_source(currentPage, 3, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
